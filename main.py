...
def other_info():
    print('Services', band.services)

    print('Services:')
    for i in band.getServices():
        print('\t' + i.uuid)
...
call_notif = FunctionItem(
    'Send a High Prority Call Notification',
    call_immediate)
msg_notif = FunctionItem(
    'Send a Medium Prority Message Notification',
    msg_immediate)
